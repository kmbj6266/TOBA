...
public class ReportSpreadSheetServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // try/catch  to query databse for User info with current 
        try {
            ...
            // Iterate through the results of the query and place data in correct column, but not sure
            int i = 2;
            while(results.next()) {
